...
import com.example.taskapp.databinding.FragmentImportTaskBinding
...
class ImportTaskFragment : Fragment() {
    lateinit var binding: FragmentImportTaskBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentImportTaskBinding.inflate(layoutInflater)
            ...
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                if (snapshot.exists()) {
                    for (taskSnap in snapshot.children) {
                        ...
                        taskData?.let {
                            if ((it.userId == uId) && (it.isChecked!!)  && (it.taskImport == true)) {
                                dsTaskCom.add(it)
                    ...
                    cAdapter.setOnItemClickListener(object : TaskAdapter.onItemClickListener {
                        override fun onItemClick(position: Int) {
                            ...
                            i1.putExtra("fragment_import", "ImportTaskFragment")
                            startActivity(i1)
                        }
